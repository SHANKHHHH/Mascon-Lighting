  ...
  <div className="w-[676px] h-[709px]">
    <div className="bg-white rounded-3xl shadow-[0_0_20px_rgba(0,0,0,0.1)] overflow-hidden">
      ...
      <div className="p-8">
        ...
        <button className="inline-flex w-[150px] h-[49px] items-center gap-2 px-6 py-3 border-2 border-[#004B6E] text-[#004B6E] rounded-lg font-medium hover:bg-blue-50 transition-colors">
