...
const AppContent = () => {
  ...
  useEffect(() => {
    ...
    if (location.pathname === "/") {
      // On home page, set to home initially, then scroll handler will update if needed
  ...
  useEffect(() => {
    // Only use scroll detection on home page
    ...
    <div className="min-h-screen m-0 p-0">
      ...
      <div className="relative">
        <Routes>
          ...
          />
          <Route path="/product/icemoon" element={<ProductPage />} />
          <Route path="/blog/illuminate-your-space" element={<BlogDetail />} />
          <Route path="/collections" element={<CollectionsDetail />} />
...
function App() {
  return (
    <Router basename="/Mascon-Lighting">
      <AppContent />
    </Router>
  );
}
